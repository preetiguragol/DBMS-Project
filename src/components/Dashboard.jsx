...
const Dashboard = () => {
    ...
    const plansAndOffers = [
        ...
        { id: 3, title: 'Entertainment', description: 'Unlimited internet upto 200mbps,unlimited local/STD calls,with benefits of ott subscriptions', imageUrl: 'https://img-cdn.thepublive.com/fit-in/1200x675/vnd/media/post_banners/wp-content/uploads/2021/09/A-booster-dose-for-OTT1.jpg' },
        { id: 4, title: 'Infinity', description: 'Unlimited internet upto 200mbps,unlimited local/STD calls', imageUrl: 'https://media.assettype.com/nationalherald%2F2021-12%2F28966a77-027c-4688-894a-200505c8eb2f%2F7_in_10_parents_confess_their_phone_use_hurting_relations_with_kids_Report.jpg?rect=53%2C0%2C1067%2C600&auto=format%2Ccompress&fmt=webp&w=1200' },
